import { c as create_ssr_component, a as compute_rest_props, i as getContext, v as validate_component, d as spread, e as escape_attribute_value, f as escape_object, b as add_attribute, g as compute_slots, j as escape, l as createEventDispatcher, s as setContext, k as each, o as onDestroy, h as subscribe } from "../../../chunks/ssr.js";
import { H as Heading, S as Span } from "../../../chunks/Span.js";
import { P } from "../../../chunks/P.js";
import { p as project, b as simulationType } from "../../../chunks/projects.js";
          ...
          return `${validate_component(ListgroupItem, "ListgroupItem").$$render($$result, {}, {}, {
            default: () => {
              return `${validate_component(P, "P").$$render($$result, {}, {}, {
                ...
                {
                  id: "every_iteration_" + func,
                  checked: functionSettings[func].every_iteration
                },
                {
                  checked: ($$value) => {
                    functionSettings[func].every_iteration = $$value;
                    $$settled = false;
                  }
                },
                {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })} ${validate_component(DiffusionMethodLab, "DiffusionMethodLab").$$render($$result, {}, {}, {})}` : `${$simulationType === "other" ? `${validate_component(Heading, "Heading").$$render($$result, { tag: "h6", class: "text-center" }, {}, {
    default: () => {
      return `Project: ${validate_component(Span, "Span").$$render($$result, { gradient: true }, {}, {
        default: () => {
          return `${escape($project.name)}`;
