import { c as create_ssr_component, a as compute_rest_props, v as validate_component, b as add_attribute, d as spread, e as escape_attribute_value, f as escape_object, g as compute_slots, h as subscribe, s as setContext, i as getContext, j as escape, k as each, m as missing_component } from "../../chunks/ssr.js";
/* empty css               */
  ...
  return `${validate_component(Navbar, "Navbar").$$render($$result, { fluid, color: "default" }, {}, {
    default: () => {
      return `<div class="flex w-fit items-center justify-start">${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/", class: "ms-2 md:me-24" }, {}, {
        default: () => {
          return `<img src="/images/bilkent_social_systems_group.png" class="me-3 h-6 sm:h-8" alt="Temp Logo"> <span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white sm:text-2xl" data-svelte-h="svelte-163lqbi">Crowd</span>`;
        }
...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Card, "Card").$$render(
    ...
    {
      default: () => {
        return `<ul class="flex flex-wrap items-center gap-4 space-y-1 md:mb-0">${each(links, ({ name, href }) => {
          return `<li><a${add_attribute("href", href, 0)} class="text-sm font-normal text-gray-500 hover:underline dark:text-gray-400">${escape(name)}</a> </li>`;
        })}</ul> <div class="flex space-x-6 sm:justify-center">${each(brands, ([component, href]) => {
          return `<a${add_attribute("href", href, 0)} class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">${validate_component(component || missing_component, "svelte:component").$$render($$result, { size: "sm" }, {}, {})} </a>`;
        })}</div>`;
      }
    }
  )}`;
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<header class="sticky top-0 z-40 mx-auto w-full flex-none border-b border-gray-200 bg-white dark:border-gray-600 dark:bg-gray-800">${validate_component(Navbar_1, "Navbar").$$render($$result, {}, {}, {})}</header> <div class="overflow-hidden lg:flex"> <div class="h-full w-full overflow-y-auto">${slots.default ? slots.default({}) : ``}</div></div> ${validate_component(Footer, "Footer").$$render(
    $$result,
    {
      class: "bottom-0 mx-auto w-full flex-none",
      slot: "footer"
    },
    {},
    {}
