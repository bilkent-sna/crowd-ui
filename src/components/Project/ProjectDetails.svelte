<script>
  ...
  <FormGroup>
      ...
      {#if node_parameter_type === 'categorical'}
          <Label for="nodeName">Name</Label>
          <Input type="text" bind:value={newCategoricalParameter.name} placeholder="gender" />
          <Label for="range">Category options:</Label>
          <Input type="text" bind:value={newCategoricalParameter} placeholder="0" />
      {/if}
